...
# === 第四页：专业留言板 ===
    ...
    # 只要这行代码存在，全球用户都能在这里交流
    # ID 可以随便改，改了就会变成一个新的讨论组
    st_disqus("my-cool-ppt-2025")
    
    st.success("提示：留言需要登录 Disqus 账号（支持社交账号一键登录）。")
